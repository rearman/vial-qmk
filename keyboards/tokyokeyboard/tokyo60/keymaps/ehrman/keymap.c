...
#define RE_LCTL	LCTL_T(KC_CAPS)

const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[0] = LAYOUT_60_hhkb(
			     KC_ESC,	KC_GRAVE,	KC_7,		KC_5,		KC_3,	KC_1,	RE_9,	RE_0,	KC_2,	KC_4,	KC_6,	KC_8,		RE_LPRN,	RE_RPRN,	KC_BSLS,
			     KC_TAB,	KC_QUOT,	KC_COMM,	KC_DOT,		KC_P,	KC_Y,	KC_F,	KC_G,	KC_C,	KC_R,	KC_L,	KC_SLSH,	KC_EQL,		KC_BSPC,
			     RE_LCTL,	KC_A,		KC_O,		KC_E,		KC_U,	KC_I,	KC_D,	KC_H,	KC_T,	KC_N,	KC_S,	KC_MINS,	KC_ENT,
			     KC_LSFT,	RE_COLN,	KC_Q,		KC_J,		KC_K,	KC_X,	KC_B,	KC_M,	KC_W,	KC_V,	KC_Z,	KC_RSFT,	TT(1),
			     KC_LGUI,	KC_LALT,	KC_SPC,		KC_RALT,	KC_RGUI
			     ),

	[1] = LAYOUT_60_hhkb(
			     KC_TRNS,	KC_F11,		KC_F7,		KC_F5,		KC_F3,		KC_F1,	KC_F9,		KC_F10,	KC_F2,	KC_F4,	KC_F6,		KC_F8,		KC_F12,	KC_NO,	MO(2),
			     KC_TRNS,	KC_NO,		KC_NO,		KC_NO,		KC_PSCR,	KC_NO,	KC_NO,		KC_NO,	KC_NO,	KC_NO,	KC_NO,		KC_UP,		KC_NO,	KC_DEL,
			     KC_TRNS,	KC_HOME,	KC_NO,		KC_END,		KC_PGUP,	KC_INS,	KC_PGDN,	KC_NO,	KC_NO,	KC_NO,	KC_LEFT,	KC_RGHT,	KC_TRNS,
